    ...
    <footer className="bg-white py-24 border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-16 mb-20">
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="font-display font-bold text-2xl tracking-tighter text-brand-ink">F1TENTH<span className="text-brand-blue">.CLUB</span></span>
            </div>
          ...
          <div>
            <h4 className="font-mono text-[10px] text-brand-blue uppercase tracking-[0.2em] mb-8">Data_Node</h4>
            <ul className="space-y-4 text-slate-500 text-sm font-light leading-relaxed">
              <li>f1tenth-uci@uci.edu</li>
              <li>Robotics Lab, Engineering Gateway</li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-slate-100 gap-6">
          <p className="text-slate-300 font-mono text-[10px] tracking-widest">© 2026 F1TENTH RACING CLUB. ALL RIGHTS RESERVED.</p>
