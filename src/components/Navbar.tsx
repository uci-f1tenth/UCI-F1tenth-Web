  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 h-20">
      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <button className="px-6 py-2 bg-brand-ink text-white font-display font-bold text-xs rounded-full hover:bg-brand-blue hover:shadow-xl hover:shadow-blue-500/30 transition-all uppercase tracking-widest">
          Hub_Access
        </button>
      </div>
    </nav>
